...
import app.util.CollectionType;
import app.util.SubCollectionType;
...
//    generic method
    ...
    public String getCorrectCollectionTClass(boolean keyValue, boolean order, boolean unique,boolean fifoLifo,boolean indexing, boolean addSpeed, boolean deleteSpeed, boolean getSpeed, boolean memory,boolean sort) {
        ...
        // Set
        SubCollectionType hashSetType = new SubCollectionType("HashSet",false,false,true,false,false,true,true,false,false,false);
        SubCollectionType linkedHashSetType = new SubCollectionType("LinkedHashSet",false,true,true,false,false,true,true,false,false,false);
        SubCollectionType treeSetType = new SubCollectionType("TreeSet",false,false,true,false,false,false,false,false,false,true);
        SubCollectionType enumSetType = new SubCollectionType("EnumSet",false,true,true,false,false,true,true,false,false,false);
        // Queue
